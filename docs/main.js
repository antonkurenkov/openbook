(() => {
  ...
  const translations = {
    ...
    en: {
      skip: 'Skip to content', brand: 'GREEN DOOR', brandAria: 'GREEN DOOR — back to top', navAria: 'Navigation', langAria: 'Language switcher', navCycle: 'Cycle', navContainer: 'Container', navBooks: 'Books', navCovers: 'Covers', heroTitle: 'GREEN<br>DOOR', heroLead: 'A science-futurist cycle about memory, personhood, and choice in a world where almost everything can be replaced.', primaryLinksAria: 'Primary links', ctaOpenbook: 'Open openbook', ctaFirstBook: 'First book', heroAlt: 'Line-art composition: green door, geometry, and threshold', cycleKicker: 'cycle', cycleTitle: 'The door matters more than the wall.', cycleText: 'Green Door is a book cycle about identity, connection, and choice. Technology does not cancel the human; it only makes clearer what cannot be replaced without losing meaning.', containerTitle: 'An open edition as a branching container', containerText: 'Openbook is not a showcase for one final build. It is a container where source files, Markdown editions, covers, branches, forks, and future reading paths can coexist.', containerAlt: 'Abstract diagram of a branching container', booksTitle: 'Seven books in one arc', bookOneText: 'Archive, memory, erased bonds, and the first door into the body of the cycle.', bookTwoText: 'The tree of exile, the limit of mercy, and the door as responsibility.', bookFourTitle: 'GREEN DOOR', bookFourText: 'A threshold book: the point where private memory, an archival branch, and choice converge into one sign.', openLink: 'Open', repoLink: 'Repository', coversTitle: 'Three covers', coverOneAria: 'Open Oblivio Duorum cover', coverTwoAria: 'Open Arbor Exilii cover', coverFourAria: 'Open Green Door cover', coverOneAlt: 'Oblivio Duorum cover in black-and-white line-art style', coverTwoAlt: 'Arbor Exilii cover in high-key line art', coverFourAlt: 'Green Door book cover', coverFourCaption: 'GREEN DOOR', finalTitle: 'Read, preserve, branch', finalText: 'The site points to three places: the cycle repository, the standalone first-book edition, and the second-book folder.', toTop: 'Back to top', lightboxAria: 'Image preview', closeAria: 'Close'
    }
  };
  const getLang = () => {
